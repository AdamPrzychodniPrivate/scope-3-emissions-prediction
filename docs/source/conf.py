...
# scope_3_emissions_prediction documentation build
...
from scope_3_emissions_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "scope_3_emissions_prediction"
author = "Kedro"
...
htmlhelp_basename = "scope_3_emissions_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "scope_3_emissions_prediction.tex",
        "scope_3_emissions_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "scope_3_emissions_prediction",
        "Project scope_3_emissions_prediction codebase.",
        "Data-Science",
    )
]
